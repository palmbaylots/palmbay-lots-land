...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://frontend-release-1.preview.emergentagent.com').rstrip('/')
API = f"{BASE_URL}/api"

ADMIN_PASSWORD = 'PalmBay2024!'
BLOG_API_KEY = 'MDC1Uq6q7ebEdA4lTqkVTxRuq1e0KU240BN6EAOo8Os'
